                ...
                for file in files: #читаем рекурсивно все файлы в этом пути
                    if file.endswith('.log'): #если расширение файла .log то:
                        ...
                        if rez: #если нашли, то
                            if os.path.isdir(rez[0] + '\\Interface\\AddOns\\NSQC'): #если аддон существует, то
                                shutil.rmtree(rez[0] + '\\Interface\\AddOns\\NSQC') #удаляем аддон
                            ...
                            os.rename(rez[0] + '\\Interface\\AddOns\\NSQC-main', rez[0] + '\\Interface\\AddOns\\NSQC') #переименовтаь распакованную папку в NSQC
